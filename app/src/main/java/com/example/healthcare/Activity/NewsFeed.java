...
public class NewsFeed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView=findViewById(R.id.ask_question);
        newsFeedRecyclerView=findViewById(R.id.postlist);



        getSupportActionBar().setHomeAsUpIndicator(R.drawable.profile);// set drawable icon
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        textView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(NewsFeed.this, AskQuestion.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent=new Intent(NewsFeed.this,SetupProfile.class);
                startActivity(intent);
                return true;
            default:
...
//    public void setNewsFeedAdapter() {
//        newsFeedModelList=new ArrayList<>();
//
//        newsFeedModelList.add(new NewsFeedModel("Referective Contract Surgery: Lenzes, Lasers, and Best Practice Hacks",
//                                                "March 24, 2020",
//                                                "Referective Contract Surgery: Lenzes, Lasers, and Best Practice Hacks Referective Contract Surgery: Lenzes, Lasers, and Best Practice Hacks" +
//                                                                "Referective Contract Surgery: Lenzes, Lasers, and Best Practice HacksReferective Contract Surgery: Lenzes, Lasers, and Best Practice Hacks",
...
//
//
//        newsFeedAdapter=new NewsFeedAdapter(this,newsFeedModelList);
