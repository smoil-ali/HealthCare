...
public class UnAnswerdQuestionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_un_answerd_question, container, false);
        newsFeedRecyclerView=view.findViewById(R.id.unanswerdPostList);
